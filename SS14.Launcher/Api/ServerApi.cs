...
public static class ServerApi
{
    ...
    public sealed record ServerStatus(
        ...
        [property: JsonPropertyName("panic_bunker")] bool? PanicBunker = null,
        [property: JsonPropertyName("panic_bunker_min_account_age")] int? PanicBunkerMinAccountAge = null,
        [property: JsonPropertyName("panic_bunker_min_overall_hours")] float? PanicBunkerMinOverallHours = null);
