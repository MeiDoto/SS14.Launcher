...
public sealed class OverrideAssetsManager
{
    ...
    public static SqliteConnection GetSqliteConnection()
    {
        ...
        con.Open();
        con.Execute("PRAGMA journal_mode=WAL; PRAGMA synchronous=NORMAL; PRAGMA busy_timeout=30000;");
        return con;
    }

    private static string GetDbConnectionString()
    {
        return $"Data Source={LauncherPaths.PathOverrideAssetsDb};Mode=ReadWriteCreate;Default Timeout=30;Foreign Keys=True";
    }
}
