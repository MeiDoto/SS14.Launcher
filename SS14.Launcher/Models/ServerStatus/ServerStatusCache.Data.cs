...
public sealed class ServerStatusData : ObservableObject, IServerStatusData
{
    ...
    private float? _panicBunkerMinOverallHours;
    ...
    public int? PanicBunkerMinAccountAge
    {
        get => _panicBunkerMinAccountAge;
        set => SetProperty(ref _panicBunkerMinAccountAge, value);
    }

    public float? PanicBunkerMinOverallHours
    {
        get => _panicBunkerMinOverallHours;
        set => SetProperty(ref _panicBunkerMinOverallHours, value);
    }
