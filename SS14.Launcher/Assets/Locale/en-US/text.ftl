...
connecting-status-client-crashed = Client crashed (exit code: {$code}). If this persists, please ask on Discord or GitHub for support.
...
launcher-customizer-bg-heading = Background Wallpaper
launcher-customizer-glass-opacity = Glass Tint:
launcher-customizer-logo-heading = Custom Game Logo
...
tab-options-storage-usage = 💾 Storage: Total { $total } (Content: { $content }, Engines: { $engines }, Replays: { $replays }, Logs: { $logs })
tab-options-notify-test-msg = Desktop notifications are working properly!
...
tab-replays-sort-duration-desc = Duration (Longest first)
tab-replays-sort-duration-asc = Duration (Shortest first)
tab-replays-stats-total-label = Replays
tab-replays-stats-size-label = Total Size
tab-replays-stats-time-label = Play Time
tab-replays-stats-favs-label = Favorites
tab-replays-filter-favorites = Favorites
tab-replays-cleaner-button = Cleaner
tab-replays-cleaner-tooltip = Smart cleanup of old and corrupted recordings
tab-replays-batch-button = Select
tab-replays-batch-tooltip = Toggle multi-select batch mode
tab-replays-filter-mode-label = Mode:
tab-replays-filter-server-label = Server:
tab-replays-filter-all-gamemodes = All Modes
tab-replays-filter-all-servers = All Servers
tab-replays-batch-select-all = Select All
tab-replays-batch-deselect-all = Deselect All
tab-replays-batch-delete-selected = Delete Selected ({ $count })
tab-replays-batch-cancel = Cancel
tab-replays-card-copy = Summary
tab-replays-card-folder = Folder
tab-replays-card-details = Details
tab-replays-card-delete = Delete
tab-replays-card-fav-tooltip = Add / remove favorite
tab-replays-card-share-tooltip = Copy round summary card for Discord/Reddit
tab-replays-card-folder-tooltip = Open containing folder
tab-replays-copied-summary = Summary copied to clipboard!
tab-replays-export-picker-title = Export Replay File
...
launcher-customizer-tab-sandbox = Script Sandbox
launcher-customizer-live-preview-title = Interactive Live Preview
launcher-customizer-live-preview-subtitle = Instantly previews colors, fonts and UI controls
launcher-customizer-live-preview-mock-server = SS14 Official Server [MRP]
launcher-customizer-live-preview-mock-connect = Connect
launcher-customizer-live-preview-mock-time = 1h 45m
...
launcher-customizer-palette-heading = Active Palette:
launcher-customizer-palette-accent = Accent
launcher-customizer-palette-buttons = Buttons
launcher-customizer-palette-tabs = Tabs
launcher-customizer-palette-text = Text
launcher-customizer-palette-windows = Windows
...
launcher-customizer-color-accent = Accent Color:
launcher-customizer-color-button = Button Color:
launcher-customizer-color-tab-selected = Active Tab Color:
launcher-customizer-color-text = Text Color:
launcher-customizer-color-popup = Card & Popup Background:
...
launcher-customizer-random-palette = 🎲 Random Palette
launcher-customizer-clear-script = Clear
customizer-script-palette-generated = Generated a new harmonious palette!
customizer-script-cleared = Script editor cleared.
...
account-info-copied = Copied ✓
account-info-sensitive-warning = Do not share your User ID or HWID — these identifiers are unique to your account and hardware.
...
tab-dev-cleared-playtime = ✓ Playtime history cleared.
tab-dev-cleared-slots = ✓ Slot watcher list cleared.
tab-dev-cleared-news-cache = ✓ Offline news cache cleared.
tab-dev-cleared-cvars = ✓ All CVars reset to default values.
tab-dev-error-action = ⚠ Error: { $error }
...
log-viewer-filter-all = All
log-viewer-filter-errors = Errors
log-viewer-filter-warnings = Warnings
log-viewer-filter-info = Info
log-viewer-filter-debug = Debug
...
local-builds-empty-title = No Saved Builds
local-builds-empty-desc = Add a .zip bundle or game binary above for quick launch.
local-builds-open-folder = 📁 Folder
...
server-entry-playtime-bottom = Server playtime: { $time }
...
replay-dialog-gamemode = Mode:
replay-dialog-round-id = Round ID:
...
replay-dialog-sha256 = SHA-256 Hash:
replay-dialog-copy-hash = Copy hash to clipboard
replay-dialog-hash-copied = Hash copied!
replay-dialog-favorite = Favorite
replay-dialog-share = Summary
replay-dialog-export = Export
replay-dialog-note-header = Replay Note:
replay-dialog-note-watermark = Add personal notes, memories, or tags about this round…
replay-dialog-note-save = Save
...
## Smart Replay Cleaner
replay-cleaner-title = Smart Replay Cleaner
replay-cleaner-desc = Automatically reclaim disk space by pruning outdated or corrupted round archives.
replay-cleaner-filter-age = Replay Age:
replay-cleaner-age-all = All replays (any age)
replay-cleaner-age-14 = Older than 14 days
replay-cleaner-age-30 = Older than 30 days
replay-cleaner-age-60 = Older than 60 days
replay-cleaner-age-90 = Older than 90 days
replay-cleaner-delete-corrupted = Delete corrupted / broken archives
replay-cleaner-exclude-favorites = Protect favorites (never delete)
replay-cleaner-quota = Disk Space Quota:
replay-cleaner-quota-none = No quota limit (filter by age only)
replay-cleaner-quota-1gb = Keep up to 1 GB of newest replays
replay-cleaner-quota-2gb = Keep up to 2 GB of newest replays
replay-cleaner-quota-5gb = Keep up to 5 GB of newest replays
replay-cleaner-quota-10gb = Keep up to 10 GB of newest replays
replay-cleaner-preview-header = Cleanup Preview:
replay-cleaner-preview-count-label = Replays to delete:
replay-cleaner-preview-freed-label = Space to reclaim:
...
replay-download-dialog-desc = Download replay archives directly into the launcher via direct URL or custom template.
replay-download-mode-url = Direct URL
replay-download-mode-round-id = By Round ID (Template)
replay-download-url-label = Replay archive URL (.zip):
replay-download-url-watermark = https://example.com/replays/round_12345.zip
replay-download-round-id-label = Round ID:
replay-download-round-id-watermark = e.g. 50135
replay-download-custom-template-label = Custom URL template ({"{roundId}"}):
replay-download-custom-template-hint = Enter a URL template containing the {"{roundId}"} parameter, e.g. https://server.com/replays/round_{"{roundId}"}.zip
replay-download-status-ready = Paste an archive URL or enter a round ID.
