...
public static class ConfigConstants
{
    ...
    public static readonly string LauncherCustomVersion = typeof(ConfigConstants).Assembly.GetName().Version?.ToString(3) ?? "1.1.8";
    ...
    public static readonly UrlFallbackSet AuthUrl = new([
    ...
    public static readonly UrlFallbackSet[] DefaultHubUrls = [
        new([
            ...
            "https://hub.fallback.spacestation14.com/"
        ], StatsHubInfra)
    ];
    public const string DiscordUrl = "https://discord.gg/Xf9h5rTtE";
