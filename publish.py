...
def publish_windows(x64_only: bool):
    ...
    dotnet_publish("SS14.Launcher.Bootstrap/SS14.Launcher.Bootstrap.csproj", "win-x64", True, "/p:FullRelease=True", "/p:PublishSingleFile=true", "/p:PublishTrimmed=true", "/p:TrimMode=link", "/p:OptimizationPreference=Size")
    ...
    safe_set_subsystem(f"SS14.Launcher.Bootstrap/bin/Release/{TFM}-windows/win-x64/publish/Space Station 14 Launcher.exe")
    ...
    elif not os.path.isfile(bootstrap_path):
        bootstrap_path = f"SS14.Launcher/bin/Release/{TFM}/win-x64/publish/SS14.Launcher.exe"
    ...
    shutil.copyfile("PublishFiles/create-shortcut.bat", "bin/publish/Windows/create-shortcut.bat")
    shutil.copyfile("SS14.Launcher/Assets/icon.ico", "bin/publish/Windows/SS14.ico")
...
def publish_linux(x64_only: bool):
    ...
    try:
        os.chmod("bin/publish/Linux/SS14.Launcher", 0o755)
        os.chmod("bin/publish/Linux/setup-desktop.sh", 0o755)
        os.chmod("bin/publish/Linux/SS14.desktop", 0o755)
    except Exception:
        pass
